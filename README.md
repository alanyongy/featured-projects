...
A Python AI for the AEGIS multi-agent simulation that coordinates multiple rescue robots under harsh messaging and information delays to save survivors in minimal turns.
